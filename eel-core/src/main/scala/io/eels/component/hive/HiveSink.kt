...
data class HiveSink @JvmOverloads constructor(private val dbName: String,
                                              ...
                                              private val dynamicPartitioning: Boolean? = null,
                                              private val schemaEvolution: Boolean? = null) : Sink, Logging {
  ...
  override fun writer(schema: Schema): SinkWriter {
    ...
    if (schemaEvolution ?: schemaEvolutionDefault) {
    ...
    return HiveSinkWriter(
        ...
        ioThreads,
        dialect(),
        dynamicPartitioning ?: dynamicPartitioningDefault,
