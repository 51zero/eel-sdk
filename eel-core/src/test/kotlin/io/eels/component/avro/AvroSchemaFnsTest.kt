...
import io.eels.component.avro.fromAvro
  ...
  init {
    "toAvro" should {
      "use a union of [null, type] for a nullable column" with {
        ...
        val fields = toAvro(schema).fields
    ...
    "fromAvro" should {
      "convert avro unions [null, string] to nullable columns" with {
        ...
        fromAvro(avro) shouldBe Schema(Column("str", ColumnType.String, true, 0, 0, true))
      }
      "convert avro unions [null, enum] to nullable columns" with {
        ...
        fromAvro(avro) shouldBe Schema(Column("u", ColumnType.String, true, 0, 0, true))
      }
